  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <div className={`bg-white p-6 rounded-2xl w-full ${odd} flex xs:flex-col sm:gap-4 items-center`}>
        ...
        <div className='sm:px-6 sm:py-4 xs:pt-4 xs:pb-0 flex-1'>
          <div>
          ...
          <section className='flex flex-wrap gap-3 m-3 mt-6 ml-0'>
            {
              ...
              <div
                ...
                className='project bg-yellow-200 sm:px-4 xs:px-2 h-10 text-white font-[500] h-10 rounded-[10px] flex justify-center items-center gap-2 cursor-pointer duration-200 hover:bg-point'
              >
