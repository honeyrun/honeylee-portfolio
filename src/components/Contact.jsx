    ...
    >
      ...
      >
       <div className="flex gap-5 items-center" >
        ...
        <aside>
          <h4 className="text-point font-[500] text-[19px]">Location</h4>
          <p className="text-secondary text-[15px]">Vancouver, Canada</p>
        </aside>
       </div>
      ...
      <div className="flex gap-5 items-center email" >
        ...
        <aside>
          <h4 className="text-point font-[500] text-[19px]">Email</h4>
          <p className="text-secondary text-[15px]">honeyrun5@gmail.com</p>
        </aside>
       </div>
      </a>
      ...
      <div className="flex gap-5 items-center" >
        ...
        <aside>
          <h4 className="text-point font-[500] text-[19px]">Phone</h4>
          <p className="text-secondary text-[15px]">+1) 778 636 2554</p>
        </aside>
       </div>
